...
(defparameter *rules* (Rules->Cluster (R-pitches-one-voice #'all-diff? *voices* :all-pitches) (R-pitches-one-voice (lambda (a b) (<= (abs (- a b)) 7)) *voices* :pitches) (R-pitch-pitch (lambda (sim) (or (null (first sim)) (null (second sim)) (/= (first sim) (second sim)))) '(0 1) nil :all :exclude-gracenotes :pitch)))
