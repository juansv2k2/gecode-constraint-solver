...
(setf *max-nr-of-loops* 100000000)
...
(defparameter *rules*
    (Rules->Cluster
        ...
        (R-pitch-pitch #'retro-pair? '
            (0 1) '
            (0 11/4) :at-timepoints :exclude-gracenotes :pitch)
        (R-pitch-pitch #'retro-pair? '
            (0 1) '
            (1/4 10/4) :at-timepoints :exclude-gracenotes :pitch)
        (R-pitch-pitch #'retro-pair? '
            (0 1) '
            (2/4 9/4) :at-timepoints :exclude-gracenotes :pitch)
        (R-pitch-pitch #'retro-pair? '
            (0 1) '
            (3/4 8/4) :at-timepoints :exclude-gracenotes :pitch)
        (R-pitch-pitch #'retro-pair? '
            (0 1) '
            (4/4 7/4) :at-timepoints :exclude-gracenotes :pitch)
        (R-pitch-pitch #'retro-pair? '
            (0 1) '
            (5/4 6/4) :at-timepoints :exclude-gracenotes :pitch)
        (R-pitch-pitch #'retro-pair? '
            (0 1) '
            (6/4 5/4) :at-timepoints :exclude-gracenotes :pitch)
        (R-pitch-pitch #'retro-pair? '
            (0 1) '
            (7/4 4/4) :at-timepoints :exclude-gracenotes :pitch)
        (R-pitch-pitch #'retro-pair? '
            (0 1) '
            (8/4 3/4) :at-timepoints :exclude-gracenotes :pitch)
        (R-pitch-pitch #'retro-pair? '
            (0 1) '
            (9/4 2/4) :at-timepoints :exclude-gracenotes :pitch)
        (R-pitch-pitch #'retro-pair? '
            (0 1) '
            (10/4 1/4) :at-timepoints :exclude-gracenotes :pitch)
        (R-pitch-pitch #'retro-pair? '
            (0 1) '
            (11/4 0) :at-timepoints :exclude-gracenotes :pitch)))
